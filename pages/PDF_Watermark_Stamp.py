...
from scripts.functions import save_file, delete_pdf_files, stamp, watermark
...
with st.expander(label='Job Aids'):
    st.info("""
            ...
            **Note:**
            ...
            - Ensure the watermark PDFs (e.g., Confidential_Red.pdf) exist in the assets/ directory.
            """)
...
if pdf_file:
    ...
    if st.button('Apply Watermark'):
        try:
            ...
            st.success('Selected watermark was added successfully.')
